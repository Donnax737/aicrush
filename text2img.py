...
def makeConfig(cfg=None):
    ...
    default_cfg = {
        ...
        "font-family": "Sarasa-Regular.ttf",
#        "font-family": "msyh.ttf",
        ...
        "copyright": u"本图文由AI文爱姬@aicruch_test_bot自动生成，但不代表AI文爱姬赞同其中的行为。",
...
#    txt = txt.decode("utf-8")
    ...
    words = makeLineToWordsList(txt,1)
    lines = []
...
def txt2im(txtf, outfn, cfg=None, show=False):
    txt = open(txtf, "rb").read().decode("utf-8")
    cfg = makeConfig(cfg)
